// InfinityDeviceTools.cpp : Este arquivo contém a função 'main'. A execução do programa começa e termina ali.
//
...
int main(int argc, char* argv[])
{
	...
	std::wstring wsDosDeviceName(szDosDeviceName);
	char* szcDosDeviceName;
	StringUtils::toCharPt(wsDosDeviceName, szcDosDeviceName);

	// get the device instance handle of the storage volume by means of a SetupDi enum and matching the device number
	DEVINST DevInst = GetDrivesDevInstByDeviceNumber(DeviceNumber, DriveType, szcDosDeviceName);
