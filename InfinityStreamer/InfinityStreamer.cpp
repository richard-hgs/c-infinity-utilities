// InfinityStreamer.cpp : Este arquivo contém a função 'main'. A execução do programa começa e termina ali.
//
...
// Format constants
const UINT32 VIDEO_DURATION_SECCONDS = 10;
const UINT32 VIDEO_FPS = 30;
const UINT64 VIDEO_FRAME_DURATION = VIDEO_DURATION_SECCONDS * 1000 * 1000 / VIDEO_FPS;
const UINT32 VIDEO_BIT_RATE = 2000000;
const GUID   VIDEO_ENCODING_FORMAT = MFVideoFormat_H264;
const GUID   VIDEO_INPUT_FORMAT = MFVideoFormat_RGB32;
const UINT32 VIDEO_FRAME_COUNT = VIDEO_DURATION_SECCONDS * VIDEO_FPS;
...
int main()
{
    ...
    std::cout << "LastError:" << std::to_string(GetLastError()) << std::endl;
}
